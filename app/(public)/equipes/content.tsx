...
const txt1 = "Nos Équipes";
const txt2 = "Découvrez les équipes engagées qui font vivre notre paroisse au quotidien.";
...
export default function Content() {
  return (
    <div className="w-full flex flex-col gap-12 pb-16">
      ...
      <div className="overflow-hidden px-4 max-w-7xl mx-auto flex flex-col gap-6 sm:gap-8 lg:gap-14 text-base sm:text-lg lg:text-xl text-stone-600">
        <Organisation />
        <TabsProgrammes />
        <LastSection />
      </div>
