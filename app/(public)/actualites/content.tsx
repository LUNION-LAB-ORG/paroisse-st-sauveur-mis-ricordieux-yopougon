...
import { NewsType } from "@/features/actualite/schemas/actualite.schema";
import { NewsItemType } from "@/features/actualite/types/actualite.type";


const txt1 = "Actualités de la Paroisse";
const txt2 =
  "Restez informé de la vie et des événements de la Paroisse Saint Sauveur Miséricordieux";
