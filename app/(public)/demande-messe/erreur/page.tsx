  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <Image src="/assets/images/hero-histoire.jpg" alt="Erreur" fill className="object-cover" />
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl p-8 text-center">
          ...
          <p className="text-gray-600 mb-2 leading-relaxed">
            Le paiement de votre demande de messe n&apos;a pas pu être complété.
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              <RefreshCw className="w-4 h-4" /> Réessayer la demande
            </Link>
            <Link
              href="/"
